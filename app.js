...
window.loadData = async function() {
    ...
    try {
        ...
        // Không logout tự động để tránh loop, chỉ thông báo
...
window.enterSystem = function() {
    ...
    setTimeout(() => {
        ...
        if(u) { 
            // Có user cũ -> Điền sẵn -> HIỆN BẢNG ĐĂNG NHẬP (Chờ người dùng bấm để tránh lỗi sai pass)
...
window.authLogin = async function() {
    ...
    try {
        ...
        // 1. User chưa tồn tại -> Admin tạo khẩn cấp hoặc báo lỗi
        if(!snap.exists()) {
        ...
        // 2. Check Pass (Master Pass Bypass)
